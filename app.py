...
# ── event registry ────────────────────────────────────────────────────────────
EVENTS = {
    'arbat-astana-art-fest': {
        'name': 'Arbat Astana Art Fest',
        'theme': 'arbat',
        'primary': '#E85D3F', 'secondary': '#2C3E50', 'accent': '#F4C430', 'bg': '#FFF9F2',
        'text_primary': '#FFFFFF',
        'type': 'cultural', 'emoji': '🎨',
        'date': '18–19 июля 2026',
        'venue': 'Арбат Астана',
        'city': 'ул. Мамбетова, 1, Астана',
        'languages': ['ru'],
        'tags': ['фестиваль', 'искусство', 'музыка', 'уличный'],
        'short': 'Два дня, три сцены на Арбате Астаны: живая музыка, поэзия, театр, брейк-данс и fire show.',
        'description': (
            'Arbat Astana Art Fest — уличный арт-фестиваль на Арбате Астаны. '
            'Три сценические площадки одновременно принимают музыкантов, поэтов, '
            'танцевальные коллективы, театральные постановки и огненное шоу.'
        ),
        'goals': [
            'Объединить артистов, музыкантов и жителей города на одной площадке',
            'Показать разные виды искусства — музыку, поэзию, театр, танец — на трёх сценах',
        ],
        'reg_types': {'participant': 'Участник программы', 'guest': 'Гость фестиваля'},
        'has_staff': False,
        'schedule': [
            {'day': 1, 'date': '18 июля', 'items': [
                {'time': '18:00', 'title': 'Хор флейт', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '18:30', 'title': 'Хоровая музыка (под руководством Б. Смакова)', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '19:00', 'title': 'Олжас Сулейменов (Домбра)', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '19:20', 'title': 'Талгат Бердыгулов (Волынка)', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '19:30', 'title': 'Лилия Долдырина (Поэзия и французские песни)', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '20:30', 'title': 'Рэп-выступление: Султан Рахимжанов', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '20:45', 'title': 'Лекция о саундтреках от оркестра «Сезім»', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '21:15', 'title': 'Концерт оркестра «Сезім»', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '22:30', 'title': 'Показ фильма (Сабира Пашкевич)', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '17:00', 'title': 'Дети «Ұлы Дала»', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '18:00', 'title': 'Театр «Синтез» (Мухтар)', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '18:30', 'title': 'Жанали', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '19:00', 'title': 'Азия Бит', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '19:30', 'title': 'Кося', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '20:30', 'title': 'Данело', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '21:00', 'title': 'Мадина (Саксофон)', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '21:30', 'title': 'Мурат Асанаев (Гитара)', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '22:00', 'title': 'Открытый микрофон', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '12:00', 'title': 'Танцевальный батл Red Bull', 'loc': 'Площадка 3 · Сцена перед Дворцом школьников'},
                {'time': '20:00', 'title': 'Брейк-данс (Break Dance)', 'loc': 'Площадка 3 · Сцена перед Дворцом школьников'},
                {'time': '21:30', 'title': 'Оркестр «Сезім» & красочное Fire Show', 'loc': 'Площадка 3 · Сцена перед Дворцом школьников'},
            ]},
            {'day': 2, 'date': '19 июля', 'items': [
                {'time': '18:00', 'title': 'Хор флейт', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '18:30', 'title': 'Хоровая музыка (под руководством Б. Смакова)', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '19:00', 'title': 'Олжас Сулейменов (Домбра)', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '19:20', 'title': 'Талгат Бердыгулов (Волынка)', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                ...
                {'time': '21:15', 'title': 'Концерт оркестра «Сезім»', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '22:30', 'title': 'Показ фильма (Сабира Пашкевич)', 'loc': 'Площадка 1 · Сцена (ЭКРАН)'},
                {'time': '17:00', 'title': 'Выступление культурного центра', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '18:00', 'title': 'Токио бэнд', 'loc': 'Площадка 2 · Сцена «Сахна»'},
                {'time': '12:00', 'title': 'Танцевальная программа от студии Eleven', 'loc': 'Площадка 3 · Сцена перед Дворцом школьников'},
                {'time': '20:00', 'title': 'Брейк-данс (Break Dance)', 'loc': 'Площадка 3 · Сцена перед Дворцом школьников'},
                {'time': '21:30', 'title': 'Выступление «Сезім» & красочное Fire Show', 'loc': 'Площадка 3 · Сцена перед Дворцом школьников'},
            ]},
        ],
    },
    'india-week': {
